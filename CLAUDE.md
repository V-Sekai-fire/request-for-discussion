...
| **Blender**                                                                 | renders are not reproducible across versions; **a version-pinned quad round-trip for blendshaped meshes is exempt** (operator directive 2026-09-12) — see below                                                                                                     |
