...
#
# RFD 1153. `mix rfd.render` in rfd_dsl/ renders rfd/1153-judging-matte-quality/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD1153 do
  use RFD.DSL

  rfd 1153, "Judging matte quality" do
    state :published
    ...
    details_title "Judging matte quality"
    ...
    details "Configuration, not capability", ~S"""
    ...
    **Aggregate ranking works; per-sample selection does not.** Spearman against true
    ...
    details "Why per-sample fails, from the methodology", ~S"""
    ...
    details "What this does not establish", ~S"""
