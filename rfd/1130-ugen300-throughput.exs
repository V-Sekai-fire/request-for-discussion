...
#
# RFD 1130. `mix rfd.render` in rfd_dsl/ renders rfd/1130-ugen300-throughput/README.md and
...
defmodule RFD1130 do
  ...
  rfd 1130, "What the UGen300 actually delivers" do
    ...
    **The third quantity is the answer to the question this RFD was written to ask.** Overall
    ...
    details "THE FIRST PORT WAS STARVING THE DEVICE, AND EVERY EARLIER NUMBER WOULD HAVE BEEN WRONG", ~S"""
    ...
    **Pipelining is where the bus idle time converts to rate.** Queueing frames through
    ...
    details "The controlled-input path needed a shim, and the flat C API does not work on H10", ~S"""
