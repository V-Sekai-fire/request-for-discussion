...
#
# RFD 1148. `mix rfd.render` in rfd_dsl/ renders rfd/1148-the-runtime-that-reaches-the-device/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD1148 do
  use RFD.DSL

  rfd 1148, "The runtime that reaches the device" do
    state :discussion
    ...
    **The accelerators are binaries we receive.** No LiteRT GPU accelerator
    ...
    details_title "The runtime that reaches the device"

    details "The accelerator is a binary, and the build settles it", ~S"""
    ...
    details "What the three wheels ship", ~S"""
    ...
    details "The vendor ABI, for the Hailo work", ~S"""
    ...
    details "StableHLO sits upstream of the flatbuffer", ~S"""
    ...
    details "What Metal reaches, measured", ~S"""
    ...
    **This harness declines to rank fp16 against f32, and the reason is an artefact worth
    ...
    details "Hailo takes TFLite by its own direction", ~S"""
