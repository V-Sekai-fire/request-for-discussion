...
#
# RFD 2136. `mix rfd.render` in rfd_dsl/ renders rfd/2136-the-gacha-critical-path/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2136 do
  use RFD.DSL

  rfd 2136, "The gacha critical path, as a ladder" do
    compact_head true
    ...
    details_title "The gacha critical path, as a ladder"
