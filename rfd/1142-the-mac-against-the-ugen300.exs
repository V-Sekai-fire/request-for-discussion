...
#
# RFD 1142. `mix rfd.render` in rfd_dsl/ renders rfd/1142-the-mac-against-the-ugen300/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD1142 do
  use RFD.DSL

  rfd 1142, "The Mac against the UGen300" do
    state :discussion
    ...
    **Metal is the Mac's engine here, and the Neural Engine is blocklisted.**
    ...
    details_title "The Mac against the UGen300"
    ...
    details "The placement gate, and why it comes first", ~S"""
    ...
    details "Two ceilings, and the first sweep found neither", ~S"""
    ...
    details "Throughput, and a cliff that is not the ceiling", ~S"""
    ...
    **13.583 TFLOP/s, 86.0% of the cited 15.8 TOPS**, is the best rate with every
    ...
    details "The same graph on Metal", ~S"""
    ...
    **6.98 TFLOP/s against the Neural Engine's 13.58 on the same graph, 1.95x.** This also
    ...
    details "The comparison, on the two axes that decide it", ~S"""
    ...
    **The crossover is 2 GiB of weights.** Under it the Mac runs at 13.58 against the
    ...
    details "The real model, converted natively, and what it settles", ~S"""
    ...
    **A comparison that paired outputs by shape.** The device half returns two tensors of
    ...
    details "What this does NOT resolve", ~S"""
    ...
    details "Four bits, and why the column is absent", ~S"""
