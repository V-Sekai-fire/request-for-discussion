...
#
# RFD 2185. `mix rfd.render` in rfd_dsl/ renders rfd/2185-flow-lcm-qaft-lumina2-distillation/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2185 do
  use RFD.DSL

  rfd 2185, "Flow-LCM + QAFT-nf4 combined distillation for Lumina-Image-2.0" do
    compact_head true
    ...
    details_title "Flow-LCM + QAFT-nf4 combined distillation for Lumina-Image-2.0"
