...
#
# RFD 2083. `mix rfd.render` in rfd_dsl/ renders rfd/2083-zone-server-h2o-replaces-godot-fabriczone/README.md and
...
defmodule RFD2083 do
  ...
  rfd 2083, "Zone server h2o replaces godot fabriczone" do
    ...
    details_title "Zone server h2o replaces godot fabriczone"
