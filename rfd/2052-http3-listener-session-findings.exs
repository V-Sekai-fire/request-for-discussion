...
#
# RFD 2052. `mix rfd.render` in rfd_dsl/ renders rfd/2052-http3-listener-session-findings/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2052 do
  use RFD.DSL

  rfd 2052, "Http3 listener session findings" do
    state :prediscussion
