...
#
# RFD 2080. `mix rfd.render` in rfd_dsl/ renders rfd/2080-slotmap-entity-storage/README.md and
...
defmodule RFD2080 do
  ...
  rfd 2080, "Slotmap entity storage" do
    ...
    details_title "Slotmap entity storage"
    ...
    **Iterate** (tick all entities):
    ...
    details "Why not just a flat array?", ~S"""
    ...
    details "Why not entt / flecs / an ECS framework?", ~S"""
    ...
    details "Relationship to other RFDs", ~S"""
