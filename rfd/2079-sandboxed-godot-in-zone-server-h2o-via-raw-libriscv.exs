...
#
# RFD 2079. `mix rfd.render` in rfd_dsl/ renders rfd/2079-sandboxed-godot-in-zone-server-h2o-via-raw-libriscv/README.md and
...
defmodule RFD2079 do
  ...
  rfd 2079, "Sandboxed godot in zone server h2o via raw libriscv" do
    ...
    details_title "Sandboxed godot in zone server h2o via raw libriscv"
