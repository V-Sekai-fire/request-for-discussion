...
#
# RFD 2074. `mix rfd.render` in rfd_dsl/ renders rfd/2074-binary-value-encoding-for-fdb/README.md and
...
defmodule RFD2074 do
  ...
  rfd 2074, "Binary value encoding for fdb" do
    ...
    details_title "Binary value encoding for fdb"
