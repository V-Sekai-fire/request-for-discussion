...
#
# RFD 2025. `mix rfd.render` in rfd_dsl/ renders rfd/2025-tenseless-continuous-present-voice/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2025 do
  use RFD.DSL

  rfd 2025, "Tenseless continuous present voice" do
    state :prediscussion
    ...
    details_title "Tenseless continuous present voice"
