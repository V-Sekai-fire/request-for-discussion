...
#
# RFD 2085. `mix rfd.render` in rfd_dsl/ renders rfd/2085-the-gyre-mud-setting-on-the-loot-action-shell/README.md and
...
defmodule RFD2085 do
  ...
  rfd 2085, "The gyre mud setting on the loot action shell" do
    ...
    details_title "The gyre mud setting on the loot action shell"
    ...
    details "Party composition and tone", ~S"""
    ...
    details "The web target and save data", ~S"""
    ...
    details "Mapping The Gyre onto the Hub/Field shell", ~S"""
    ...
    details "Entity and item concepts", ~S"""
    ...
    details "Example room description", ~S"""
    > **[The Splicer's Den]**
    >
    ...
    details "Session pacing (120 minutes)", ~S"""
    ...
    details "Smallest-loop implementation status", ~S"""
