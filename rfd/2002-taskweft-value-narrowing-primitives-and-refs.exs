...
#
# RFD 2002. `mix rfd.render` in rfd_dsl/ renders rfd/2002-taskweft-value-narrowing-primitives-and-refs/README.md and
...
defmodule RFD2002 do
  ...
  rfd 2002, "Taskweft value narrowing primitives and refs" do
    ...
    details_title "Taskweft value narrowing primitives and refs"
    ...
    details "Open questions and verification", ~S"""
