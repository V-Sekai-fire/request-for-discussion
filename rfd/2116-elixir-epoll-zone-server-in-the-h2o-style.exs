...
#
# RFD 2116. `mix rfd.render` in rfd_dsl/ renders rfd/2116-elixir-epoll-zone-server-in-the-h2o-style/README.md and
...
defmodule RFD2116 do
  ...
  rfd 2116, "Elixir epoll zone server in the h2o style" do
    ...
    details_title "Elixir epoll zone server in the h2o style"

    details "Why the native tier is not affordable", ~S"""
    ...
    details "What does not carry over", ~S"""
    ...
    details "The Gyre keeps its setting, not its host", ~S"""
    ...
    details "What this record does not settle", ~S"""
