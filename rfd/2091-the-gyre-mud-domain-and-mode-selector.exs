...
#
# RFD 2091. `mix rfd.render` in rfd_dsl/ renders rfd/2091-the-gyre-mud-domain-and-mode-selector/README.md and
...
defmodule RFD2091 do
  ...
  rfd 2091, "The gyre mud domain and mode selector" do
    ...
    details_title "The gyre mud domain and mode selector"
