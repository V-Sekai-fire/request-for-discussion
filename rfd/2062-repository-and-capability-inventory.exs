...
#
# RFD 2062. `mix rfd.render` in rfd_dsl/ renders rfd/2062-repository-and-capability-inventory/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2062 do
  use RFD.DSL

  rfd 2062, "Repository and capability inventory" do
    state :moved
    ...
    details_title "Repository and capability inventory"
