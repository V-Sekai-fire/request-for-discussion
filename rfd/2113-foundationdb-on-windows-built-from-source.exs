...
#
# RFD 2113. `mix rfd.render` in rfd_dsl/ renders rfd/2113-foundationdb-on-windows-built-from-source/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2113 do
  use RFD.DSL

  rfd 2113, "Foundationdb on windows built from source" do
    state :prediscussion
    ...
    details_title "Foundationdb on windows built from source"

    details "The nine stores, and why each one failed", ~S"""
    ...
    details "What the build already shows", ~S"""
    ...
    details "Dependencies that stop the build", ~S"""
