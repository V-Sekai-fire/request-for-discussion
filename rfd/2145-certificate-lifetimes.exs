...
#
# RFD 2145. `mix rfd.render` in rfd_dsl/ renders rfd/2145-certificate-lifetimes/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2145 do
  use RFD.DSL

  rfd 2145, "Certificate lifetimes, from a risk-based ceiling" do
    state :discussion
    ...
    details_title "Certificate lifetimes, from a risk-based ceiling"

    details "Why the root cert has an expiry at all", ~S"""
    ...
    details "Why the ROTATION on the root is 5 years, not 25", ~S"""
    ...
    **NIST SP 800-57 Part 1 §5.3.6 (key lifetimes).** Recommends both
    ...
    details "Why the break-glass CA gets the SAME numbers as the root", ~S"""
    ...
    details "Why the intermediates get 3 years", ~S"""
    ...
    details "Why the leaves get 90 days / 14 days", ~S"""
    ...
    **WebTransport leaf: 14 days.** Chrome enforces 14 days as the maximum
    ...
    details "Current state, 2026-09-01", ~S"""
    ...
    details "Exceptions this rule does not cover", ~S"""
