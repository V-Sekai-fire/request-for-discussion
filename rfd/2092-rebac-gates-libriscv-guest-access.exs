...
#
# RFD 2092. `mix rfd.render` in rfd_dsl/ renders rfd/2092-rebac-gates-libriscv-guest-access/README.md and
...
defmodule RFD2092 do
  ...
  rfd 2092, "Rebac gates libriscv guest access" do
    ...
    details_title "Rebac gates libriscv guest access"
    ...
    details "What `godot-sandbox` documents today", ~S"""
    ...
    details "The existing ReBAC engine this reuses", ~S"""
    ...
    details "The two engines differ, and neither one fits as it stands", ~S"""
    ...
    details "Migrate `lean-rebac-core` to the graph shape, do not replace it", ~S"""
    ...
    details "Administrative relations: who may write edges", ~S"""
    ...
    details "The graph authors permissions. It does not enforce them.", ~S"""
