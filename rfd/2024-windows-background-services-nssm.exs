...
#
# RFD 2024. `mix rfd.render` in rfd_dsl/ renders rfd/2024-windows-background-services-nssm/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2024 do
  use RFD.DSL

  rfd 2024, "Windows background services nssm" do
    state :prediscussion
    ...
    details_title "Windows background services nssm"
