...
defmodule RFD1125 do
  ...
  rfd 1125, "Two prose gates, marked per section" do
    state :discussion
    ...
    **A rule ships only after it runs against the corpus**, the bar RFD 1124 set.
    ...
    details_title "Two prose gates, marked per section"
    ...
    details "Why the rule was split", ~S"""
    <!-- gate: tropes -->
    ...
    details "Three detectors cannot fire", ~S"""
    <!-- gate: ste100 -->
    ...
    details "Every hit is a false positive", ~S"""
    <!-- gate: ste100 -->
    ...
    details "What no mechanical detector reaches", ~S"""
    <!-- gate: ste100 -->
    ...
    details "The conflict this RFD resolves", ~S"""
    <!-- gate: tropes -->
