...
#
# RFD 2044. `mix rfd.render` in rfd_dsl/ renders rfd/2044-lean4-kernel-cores-flat-c-host-adapters/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2044 do
  use RFD.DSL

  rfd 2044, "Lean4 kernel cores flat c host adapters" do
    state :prediscussion
    ...
    details_title "Lean4 kernel cores flat c host adapters"
