...
defmodule RFD2084 do
  ...
  rfd 2084, "Zstd compression for zone state" do
    ...
    details_title "Zstd compression for zone state"
    ...
    details "When NOT to compress", ~S"""
    ...
    details "Relationship to mas-bandwidth/fps", ~S"""
    ...
    details "Relationship to RFD 2010 (binary value encoding)", ~S"""
