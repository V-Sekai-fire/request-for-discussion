...
#
# RFD 2087. `mix rfd.render` in rfd_dsl/ renders rfd/2087-avatar-ik-sinew-mocap-align-over-mink/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2087 do
  use RFD.DSL

  rfd 2087, "Avatar ik sinew mocap align over mink" do
    state :moved
    ...
    details_title "Avatar ik sinew mocap align over mink"
    ...
    details "What mink actually is", ~S"""
    ...
    details "Revision 1 (superseded)", ~S"""
    ...
    details "Revision 2: the actual decision", ~S"""
    ...
    details "Revision 3: MuJoCo dropped", ~S"""
