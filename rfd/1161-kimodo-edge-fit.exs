...
#
# RFD 1161. `mix rfd.render` in rfd_dsl/ renders rfd/1161-kimodo-edge-fit/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD1161 do
  use RFD.DSL

  rfd 1161, "Kimodo is the smallest catalog model, and it is a decoder" do
    state :discussion
    ...
    **Un-abandoned 2026-09-04.** RFD 2199 parked, zoo-DETR revive
    ...
    details_title "Kimodo is the smallest catalog model, and it is a decoder"

    details "The 2026-08-28 abandonment paragraph, as history", ~S"""
