...
#
# RFD 2070. `mix rfd.render` in rfd_dsl/ renders rfd/2070-loop-slice-telemetry-to-the-observability-collector/README.md and
...
defmodule RFD2070 do
  ...
  rfd 2070, "Loop slice telemetry to the observability collector" do
    ...
    details_title "Loop slice telemetry to the observability collector"
