...
#
# RFD 1046. `mix rfd.render` in rfd_dsl/ renders rfd/1046-skintokens-auto-rig/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD1046 do
  use RFD.DSL

  rfd 1046, "Model image for skintokens_auto_rig" do
    state :discussion
    ...
    details_title "Model image for skintokens_auto_rig"
    ...
    details "The joint order trap", ~S"""
