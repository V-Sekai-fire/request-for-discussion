...
#
# RFD 2144. `mix rfd.render` in rfd_dsl/ renders rfd/2144-fdb-dr-runbook-first-run/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2144 do
  use RFD.DSL

  rfd 2144, "The DR runbook runs, and the CA it needed lands" do
    state :discussion
    ...
    details_title "The DR runbook runs, and the CA it needed lands"
    ...
    details "The R2 snapshot, described from the recovered machine", ~S"""
    ...
    details "The runbook and what it hid", ~S"""
    ...
    **12. `awk -F=` truncates the trailing `=` in base64 values.** A
    ...
    details "The recovery, step by step", ~S"""
