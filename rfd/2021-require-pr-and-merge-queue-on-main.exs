...
#
# RFD 2021. `mix rfd.render` in rfd_dsl/ renders rfd/2021-require-pr-and-merge-queue-on-main/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2021 do
  use RFD.DSL

  rfd 2021, "Require pr and merge queue on main" do
    state :prediscussion
    ...
    details_title "Require pr and merge queue on main"
