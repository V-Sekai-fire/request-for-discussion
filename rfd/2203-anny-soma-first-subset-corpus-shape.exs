...
#
# RFD 2203. `mix rfd.render` in rfd_dsl/ renders rfd/2203-anny-soma-first-subset-corpus-shape/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2203 do
  use RFD.DSL

  rfd 2203, "The first-subset row shape for the anny-soma keypoint corpus" do
    state :discussion
    ...
    details "The three row shapes and the axis they trade against", ~S"""
    ...
    **Hybrid.** `image`, `camera`, `anny_posed_vertices`, `keypoints_2d` (baked at the `.pth`
    ...
    details "The SOMA pose column and its verification hook", ~S"""
    ...
    details "The topology decision and the accuracy verification hook", ~S"""
    ...
    details "The RFD 1122 lineage", ~S"""
    ...
    **The mesh is rung one, not the destination.** Carried by RFD 1121: garment layers come from
    ...
    details "What the first subset covers", ~S"""
    ...
    details "Projection accuracy: verified (bone-level and vertex-side)", ~S"""
