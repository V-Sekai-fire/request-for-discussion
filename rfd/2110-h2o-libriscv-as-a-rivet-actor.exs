...
#
# RFD 2110. `mix rfd.render` in rfd_dsl/ renders rfd/2110-h2o-libriscv-as-a-rivet-actor/README.md and
...
defmodule RFD2110 do
  ...
  rfd 2110, "H2o libriscv as a rivet actor" do
    ...
    details_title "H2o libriscv as a rivet actor"

    details "The child contract", ~S"""
    | Item             | Value                                                        |
    | ---------------- | ------------------------------------------------------------ |
    ...
    details "What one process per room deletes", ~S"""
    ...
    details "The actor input, from `container-runner/src/input.rs`", ~S"""
    ...
    details "The pinned engine, verified", ~S"""
    ...
    details "A second child kind, kept in reserve", ~S"""
    ...
    details "The transport, settled by the runner's source", ~S"""
    ...
    details "What stays open from RFD 2109", ~S"""
