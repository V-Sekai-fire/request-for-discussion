...
#
# RFD 2134. `mix rfd.render` in rfd_dsl/ renders rfd/2134-cluster-tls-is-decided-before-data/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2134 do
  use RFD.DSL

  rfd 2134, "Cluster TLS is decided before data, and certificates carry v3 extensions" do
    state :discussion
    ...
    details_title "Cluster TLS is decided before data, and certificates carry v3 extensions"
    ...
    details "The procedure on a live plaintext cluster", ~S"""
    ...
    details "What the prod verification measured", ~S"""
    ...
    details "The backup, measured locally and blocked on SNI in prod", ~S"""
