...
#
# RFD 2053. `mix rfd.render` in rfd_dsl/ renders rfd/2053-integral-entity-transform-wire/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2053 do
  use RFD.DSL

  rfd 2053, "Integral entity transform wire" do
    state :prediscussion
    ...
    details_title "Integral entity transform wire"
    ...
    details "Related repositories", ~S"""
