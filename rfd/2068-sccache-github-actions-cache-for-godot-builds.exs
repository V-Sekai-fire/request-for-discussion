...
#
# RFD 2068. `mix rfd.render` in rfd_dsl/ renders rfd/2068-sccache-github-actions-cache-for-godot-builds/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2068 do
  use RFD.DSL

  rfd 2068, "Sccache github actions cache for godot builds" do
    state :prediscussion
    ...
    details_title "Sccache github actions cache for godot builds"
