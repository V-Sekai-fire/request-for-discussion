...
#
# RFD 2028. `mix rfd.render` in rfd_dsl/ renders rfd/2028-hexagonal-core-ports-adapters/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2028 do
  use RFD.DSL

  rfd 2028, "Hexagonal core ports adapters" do
    state :prediscussion
    ...
    details_title "Hexagonal core ports adapters"
