...
#
# RFD 2197. `mix rfd.render` in rfd_dsl/ renders rfd/2197-maskscore-rung-1-bootstrap-hf-restructure/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2197 do
  use RFD.DSL

  rfd 2197, "Restructure maskscore-rung-1-bootstrap for the HF viewer" do
    state :discussion
    ...
    details_title "Restructure maskscore-rung-1-bootstrap for the HF viewer"

    details "Amendment 2026-09-04: join keys, speech schema, media budget", ~S"""
