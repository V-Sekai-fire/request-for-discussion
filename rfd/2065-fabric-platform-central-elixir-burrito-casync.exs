...
#
# RFD 2065. `mix rfd.render` in rfd_dsl/ renders rfd/2065-fabric-platform-central-elixir-burrito-casync/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2065 do
  use RFD.DSL

  rfd 2065, "Fabric platform central elixir burrito casync" do
    state :prediscussion
    ...
    details_title "Fabric platform central elixir burrito casync"
