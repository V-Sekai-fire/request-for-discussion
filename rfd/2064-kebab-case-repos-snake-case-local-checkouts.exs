...
#
# RFD 2064. `mix rfd.render` in rfd_dsl/ renders rfd/2064-kebab-case-repos-snake-case-local-checkouts/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2064 do
  use RFD.DSL

  rfd 2064, "Kebab case repos snake case local checkouts" do
    state :prediscussion
    ...
    details_title "Kebab case repos snake case local checkouts"
