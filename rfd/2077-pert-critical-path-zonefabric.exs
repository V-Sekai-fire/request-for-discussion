...
#
# RFD 2077. `mix rfd.render` in rfd_dsl/ renders rfd/2077-pert-critical-path-zonefabric/README.md and
...
defmodule RFD2077 do
  ...
  rfd 2077, "Pert critical path zonefabric" do
    ...
    details_title "Pert critical path zonefabric"
