...
#
# RFD 2117. `mix rfd.render` in rfd_dsl/ renders rfd/2117-retire-the-h2o-tier-record-set/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2117 do
  use RFD.DSL

  rfd 2117, "Retire the h2o tier record set" do
    state :prediscussion
    ...
    problem ~S"""
    | Set | Count | | --------------------------------- | ----- | | RFDs
    before this decision | 105 | | Retired to the archive | 43 | | Live
    after this decision | 62 | | Live, plus `rfd/0116`, `rfd/0117` | 64 |
    """
    ...
    details_title "Retire the h2o tier record set"
    ...
    details "The native zone tier, 12 records", ~S"""
    | RFD    | Subject                                     |
    | ------ | ------------------------------------------- |
    ...
    details "Records whose subject is an archived repository, 8 records", ~S"""
