...
#
# RFD 1000. `mix rfd.render` in rfd_dsl/ renders rfd/1000-conventions/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD1000 do
  use RFD.DSL

  rfd 1000, "Conventions" do
    state :published
    ...
    details_title "Conventions"

    details "The problem this rule answers", ~S"""
    ...
    details "Where the organization digit comes from", ~S"""
    ...
    details "Why the digits are decimal", ~S"""
    ...
    details "A third sibling: SKILL.md", ~S"""
    ...
    **It held parallel arrays until this revision, one per column, indexed
    ...
    details "What this rule does not repair", ~S"""
