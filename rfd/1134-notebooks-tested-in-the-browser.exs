...
#
# RFD 1134. `mix rfd.render` in rfd_dsl/ renders rfd/1134-notebooks-tested-in-the-browser/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD1134 do
  use RFD.DSL

  rfd 1134, "A loop notebook is tested in the browser" do
    state :discussion
    ...
    details_title "A loop notebook is tested in the browser"

    details_preamble ~S"""
    The apparatus, the failure text, and the defects that the first run found.
    """

    details "The server", ~S"""
    ...
    details "The defect this exposes", ~S"""
    ...
    details "A second defect, found by reading", ~S"""
    ...
    details "The repair, and the second run", ~S"""
    ...
    details "The round trip, re-measured", ~S"""
    ...
    details "The detector, and a retraction of the paragraph above", ~S"""
    ...
    details "The 1.56 px figure was not stale, and this retracts that call", ~S"""
    ...
    details "A wrist is not a hand", ~S"""
    ...
    details "The third run, and the two gaps it reached", ~S"""
    ...
    details "The document completes, and the score is zero for a nameable reason", ~S"""
    ...
    details "The render found the defect the residual hid", ~S"""
    ...
    details "The scorer is the next thing that needs a baseline", ~S"""
    ...
    details "The bound on a pose has two forms, and neither is wired in", ~S"""
    ...
    details "A correction: the frames were never the wrong part", ~S"""
    ...
    details "The two fitted subjects were deleted", ~S"""
