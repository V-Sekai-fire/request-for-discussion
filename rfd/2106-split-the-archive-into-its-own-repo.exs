...
#
# RFD 2106. `mix rfd.render` in rfd_dsl/ renders rfd/2106-split-the-archive-into-its-own-repo/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2106 do
  use RFD.DSL

  rfd 2106, "Split the archive into its own repo" do
    state :prediscussion
    ...
    | Path | Records | |
    ------------------------------------------------------ | ------- | |
    `_archive/decisions/` | 26 | | `_archive/decisions/attachments/` | 1
    image | | `rfd/200b-observability-stack-victoriatraces/` | 1 | |
    ...
    details_title "Split the archive into its own repo"

    details "What moved", ~S"""
    | Path                                                   | Records |
    | ------------------------------------------------------ | ------- |
    ...
    details "Link repair, which a move forces", ~S"""
    ...
    details "A broken link the move exposed", ~S"""
    ...
    details "Two archive destinations now exist", ~S"""
    ...
    details "Counts after the split", ~S"""
    | Set                                   | Count |
    | ------------------------------------- | ----- |
