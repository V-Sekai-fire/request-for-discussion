...
#
# RFD 1031. `mix rfd.render` in rfd_dsl/ renders rfd/1031-geometry-refinement-and-alpha-wrap/README.md and
...
defmodule RFD1031 do
  ...
  rfd 1031, "Geometry refinement and alpha wrap" do
    ...
    details_title "Geometry refinement and alpha wrap"

    details "What the alpha wrap does", ~S"""
    ...
    details "Blocklisted wrap tools", ~S"""
