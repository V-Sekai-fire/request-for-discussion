...
#
# RFD 1060. `mix rfd.render` in rfd_dsl/ renders rfd/1060-thirdparty-reset/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD1060 do
  use RFD.DSL

  rfd 1060, "A thirdparty/ reset" do
    state :committed
    ...
    details_title "A thirdparty/ reset"

    details "The symlink attempt, and why it failed", ~S"""
    ...
    details "The second move, in full", ~S"""
    ...
    details "Why a real move, not a rewrite of every import", ~S"""
    ...
    details "What stays at the root, and why", ~S"""
    ...
    **`LICENSE`, `TRADEMARKS`, `.formatter.exs`, `.gitattributes`,
    ...
    details "Paths this move touched", ~S"""
