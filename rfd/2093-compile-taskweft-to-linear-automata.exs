...
#
# RFD 2093. `mix rfd.render` in rfd_dsl/ renders rfd/2093-compile-taskweft-to-linear-automata/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2093 do
  use RFD.DSL

  rfd 2093, "Compile taskweft to linear automata" do
    state :prediscussion
    ...
    details_title "Compile taskweft to linear automata"
    ...
    details "What backtracks today", ~S"""
    ...
    details "What `re2` does instead", ~S"""
    ...
    details "This is not a stretch: relation expressions are path queries", ~S"""
    ...
    details "The two constructs that resist", ~S"""
    ...
    **`tuple_to_userset` moves the object.** A plain regular path query
    ...
    details "Verification this needs", ~S"""
