...
#
# RFD 1079. `mix rfd.render` in rfd_dsl/ renders rfd/1079-appsignal-observability/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD1079 do
  use RFD.DSL

  rfd 1079, "AppSignal observability, and versitygw's removal" do
    state :published
