...
#
# RFD 1174. `mix rfd.render` in rfd_dsl/ renders rfd/1174-publish-the-security-rules-against-soc2-and-iso27001/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD1174 do
  use RFD.DSL

  rfd 1174, "Publish the security rules against SOC 2 and ISO 27001" do
    state :discussion
    ...
    details_title "Publish the security rules against SOC 2 and ISO 27001"

    details "What this document adds", ~S"""
    ...
    details "Two frames rather than one", ~S"""
    ...
    details "What this RFD does not do", ~S"""
