...
#
# RFD 1040. `mix rfd.render` in rfd_dsl/ renders rfd/1040-pixal3d-image-to-textured-mesh/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD1040 do
  use RFD.DSL

  rfd 1040, "Model image for pixal3d_image_to_textured_mesh" do
    state :discussion
    ...
    details_title "Model image for pixal3d_image_to_textured_mesh"

    details "Tested in Docker", ~S"""
    ...
    details "The cascade never needs one resident set", ~S"""
    ...
    **`ATTN_BACKEND` defaults to `flash_attn`** in upstream's
    ...
    details "Three repositories download at build time", ~S"""
