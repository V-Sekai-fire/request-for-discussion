...
#
# RFD 1026. `mix rfd.render` in rfd_dsl/ renders rfd/1026-bf16-memory-per-model/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD1026 do
  use RFD.DSL

  rfd 1026, "bf16 memory per model" do
    state :published
    ...
    details_title "bf16 memory per model"
