...
#
# RFD 2012. `mix rfd.render` in rfd_dsl/ renders rfd/2012-amend-pr-before-it-enters-the-queue/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2012 do
  use RFD.DSL

  rfd 2012, "Amend pr before it enters the queue" do
    state :prediscussion
    ...
    details_title "Amend pr before it enters the queue"
