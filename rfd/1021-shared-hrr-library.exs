...
#
# RFD 1021. `mix rfd.render` in rfd_dsl/ renders rfd/1021-shared-hrr-library/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD1021 do
  use RFD.DSL

  rfd 1021, "A shared holographic algebra library" do
    state :published
    ...
    details_title "A shared holographic algebra library"
