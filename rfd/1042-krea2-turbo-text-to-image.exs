...
#
# RFD 1042. `mix rfd.render` in rfd_dsl/ renders rfd/1042-krea2-turbo-text-to-image/README.md and
...
defmodule RFD1042 do
  ...
  rfd 1042, "Model image for krea2_turbo_text_to_image" do
    ...
    details_title "Model image for krea2_turbo_text_to_image"
