...
#
# RFD 2186. `mix rfd.render` in rfd_dsl/ renders rfd/2186-omnigen2-to-lumina2-lora-transfer-qaft/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2186 do
  use RFD.DSL

  rfd 2186, "Transfer OmniGen2's image-edit capability into a Lumina2 LoRA via QAFT-4bit" do
    compact_head true
    ...
    details_title "Transfer OmniGen2's image-edit capability into a Lumina2 LoRA via QAFT-4bit"
