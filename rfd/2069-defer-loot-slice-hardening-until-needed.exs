...
#
# RFD 2069. `mix rfd.render` in rfd_dsl/ renders rfd/2069-defer-loot-slice-hardening-until-needed/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2069 do
  use RFD.DSL

  rfd 2069, "Defer loot slice hardening until needed" do
    state :prediscussion
    ...
    details_title "Defer loot slice hardening until needed"
