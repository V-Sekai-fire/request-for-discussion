...
#
# RFD 2089. `mix rfd.render` in rfd_dsl/ renders rfd/2089-flyio-over-podman-quadlets/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2089 do
  use RFD.DSL

  rfd 2089, "Flyio over podman quadlets" do
    state :prediscussion
    ...
    details_title "Flyio over podman quadlets"
