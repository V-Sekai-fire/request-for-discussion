...
#
# RFD 1023. `mix rfd.render` in rfd_dsl/ renders rfd/1023-ports-and-adapters-with-headless-cms-style/README.md and
...
defmodule RFD1023 do
  ...
  rfd 1023, "Ports and adapters, in the headless content style" do
    ...
    **The chain reaches into content.** Four modules of content code
    ...
    details_title "Ports and adapters, in the headless content style"

    details "The layout", ~S"""
    ```
