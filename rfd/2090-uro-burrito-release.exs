...
#
# RFD 2090. `mix rfd.render` in rfd_dsl/ renders rfd/2090-uro-burrito-release/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2090 do
  use RFD.DSL

  rfd 2090, "Uro burrito release" do
    state :moved
    ...
    details_title "Uro burrito release"
