...
#
# RFD 2045. `mix rfd.render` in rfd_dsl/ renders rfd/2045-loot-action-core-loop-mvp-vertical-slice/README.md and
# DETAILS.md from this file; the Markdown is a build artifact (RFD 2232).
defmodule RFD2045 do
  use RFD.DSL

  rfd 2045, "Loot action core loop mvp vertical slice" do
    state :prediscussion
    ...
    details_title "Loot action core loop mvp vertical slice"
